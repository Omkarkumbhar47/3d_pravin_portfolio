...
const Footer = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-800 to-gray-900">
      <hr className="py-2 lg:py-4border-gray-200 sm:mx-auto dark:border-gray-700 " />
      {location.pathname === "/gallery" ? (
        ...
        <footer className="mx-auto w-full max-w-screen-xl">
          ...
          <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
          <div className="sm:flex sm:items-center sm:justify-between md:mx-10 pb-6">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 2025
              <a href="/" className="hover:underline">
                Pravin
