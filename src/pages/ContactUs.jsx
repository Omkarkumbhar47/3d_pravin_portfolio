    ...
    <section className="py-16 bg-gray-100">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Contact Information */}
          <div className="p-8 bg-indigo-600 text-white rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold mb-6">Contact Information</h3>
            <ul className="space-y-4">
              <li>
                📍 <strong>Location:</strong> Kolhapur, India
              </li>
              <li>
                📞 <strong>Phone:</strong> <a href="tel:+919075739271">+91 9075739271</a>
              </li>
              <li>
                📧 <strong>Email:</strong>{" "}
              ...
              <li>
                ...
                <a href="https://www.behance.net/pravinkamble9" target="_blank" rel="noreferrer">
                  Pravin's Portfolio
                </a>
              </li>
            </ul>
